...
//		Thread.sleep(2000);
//		driver.findElement(By.xpath("//span[text()='CV analysis']")).isDisplayed();
//		driver.quit();
//		
//		//Test 2:- Unsuccessful Login Test
//		WebDriver driver2 = new ChromeDriver();
//		driver2.get("https://app.germanyiscalling.com/common/login/?next=https%3A%2F%2Fapp.germanyiscalling.com%2Fcv%2Fhome%2F");
//		driver2.manage().window().maximize();	
//		driver2.findElement(By.xpath("//input[@name='username']")).sendKeys("ganeshkumarreddy411@gmail.com");
//		Thread.sleep(2000);
//		driver2.findElement(By.xpath("//input[@name='password']")).sendKeys("admin@1234");
//		Thread.sleep(2000);
//		driver2.findElement(By.xpath("//button[text()='Log In']")).click();
//		Thread.sleep(2000);
//		driver2.findElement(By.xpath("//li[text()='Please enter a correct username and password. Note that both fields may be case-sensitive.']")).isDisplayed();
//		driver2.quit();
//	}
//}
